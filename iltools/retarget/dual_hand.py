    ...
    def __init__(
        ...
        *,
        ...
        if (
            ...
            raise ValueError("Solver parameters and task weights must be positive.")
    ...
    def _solve_frame(
        ...
        for _ in range(self.iterations):
            ...
            for site_id, target_pose in zip(self._site_ids, target_poses, strict=True):
                ...
                errors.append(np.concatenate((position_error, orientation_error)))
                ...
                jacobians.append(
                    np.vstack((position_jacobian, rotation_jacobian))[
            ...
            q[self._arm_target_indices] = np.clip(
                q[self._arm_target_indices] + delta,
